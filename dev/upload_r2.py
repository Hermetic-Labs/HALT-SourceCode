"""
Upload HALT-v1.0.zip to Cloudflare R2.

One-shot script — reads CF_ACCOUNT_ID, CF_R2_ACCESS_KEY, CF_R2_SECRET_KEY
from environment, uploads via multipart (100 MB chunks, 4 threads) with
live progress. Prime-author only; not part of the build pipeline.
"""
import os
import sys
...
s3 = boto3.client(
    "s3", endpoint_url=endpoint_url, aws_access_key_id=ACCESS_KEY, aws_secret_access_key=SECRET_KEY, region_name="auto"
)
